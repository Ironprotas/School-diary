    ...
    public class ReportController : Controller
    {
        ...
        public async Task<IActionResult> ReportForStudent(string userName, int? classyear)
        {
            ...
            if (user != null)
            {
                ...
                workbook.SaveAs($"Report for {userName}.xlsx");
                string path = Path.Combine(_appEnvironment.ContentRootPath, $"Report for {userName}.xlsx");
        ...
        public async Task<IActionResult> ReportForClass([FromBody] List<string> nameLessons)
        {
            ...
            workbook.SaveAs("Files/Class Response.xlsx");
            string path = Path.Combine(_appEnvironment.ContentRootPath, "Files/Class Response.xlsx");
            string file_type = "application/xlsx";
            return PhysicalFile(path, file_type);             
        ...
        public async Task<IActionResult> ReportForLesson(string nameLesson)
        {
            ...
            workbook.SaveAs($"Average score on {nameLesson}.xlsx");
            string path = Path.Combine(_appEnvironment.ContentRootPath, $"Average score on {nameLesson}.xlsx");
            string file_type = "application/xlsx";
            return PhysicalFile(path, file_type);
